...
export const BUILTIN_TEMPLATES: WorkflowTemplate[] = [
  {
    ...
    nodes: [
      { id: 'analyze', name: 'Analyze', type: 'task', dependencies: [] },
      { id: 'implement', name: 'Implement', type: 'task', dependencies: ['analyze'] },
      { id: 'review', name: 'Review', type: 'task', dependencies: ['implement'] },
      { id: 'test', name: 'Test', type: 'task', dependencies: ['review'] },
    ],
  },
  {
    id: 'feature-flow',
    ...
    nodes: [
      { id: 'plan', name: 'Plan', type: 'task', dependencies: [] },
      { id: 'design', name: 'Design', type: 'task', dependencies: ['plan'] },
      { id: 'implement', name: 'Implement', type: 'task', dependencies: ['design'] },
      { id: 'verify', name: 'Verify', type: 'task', dependencies: ['implement'] },
    ],
  },
  {
    id: 'test-suite',
    ...
    nodes: [
      { id: 'unit-tests', name: 'Unit Tests', type: 'task', dependencies: [] },
      { id: 'integration-tests', name: 'Integration Tests', type: 'task', dependencies: ['unit-tests'] },
      { id: 'e2e-tests', name: 'E2E Tests', type: 'task', dependencies: ['integration-tests'] },
      { id: 'report', name: 'Report', type: 'task', dependencies: ['e2e-tests'] },
    ],
  },
];
