...
/** 左侧面板类型 */
export type LeftPanelType = 'files' | 'git' | 'todo' | 'translate' | 'scheduler' | 'longGoal' | 'requirement' | 'terminal' | 'tools' | 'developer' | 'integration' | 'problems' | 'demoPlugin' | 'comicStudio' | 'none';
