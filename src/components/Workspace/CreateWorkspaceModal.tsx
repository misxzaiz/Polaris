  ...
  return (
    <>
      ...
      {createPortal(
        ...
        >
          <div ref={modalRef} data-modal="create-workspace" className="bg-background-elevated rounded-xl p-4 sm:p-6 w-full max-w-md sm:max-w-lg border border-border shadow-glow mx-2 sm:mx-0">
