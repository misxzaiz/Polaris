...
export const SPIDERMAN_THEME: ThemeDefinition = {
  ...
  immersive: {
    ...
    wallpaper: {
      type: 'image',
      image: 'https://images.unsplash.com/photo-1534809027769-b00d750a6bac?q=80&w=1920',
      opacity: 0.8,
      positionX: 50,
      positionY: 50,
      size: 'cover',
    ...
    avatar: {
      url: 'https://www.pngmart.com/files/10/Spider-Man-Mask-Logo-PNG-Transparent-Image.png',
    },
  },
};
