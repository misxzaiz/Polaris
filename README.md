...
Polaris 是一款基于 Tauri 2.x 构建的跨平台桌面应用，为多种 AI 编程 CLI 工具提供统一的图形化操作界面，支持 **Claude Code CLI**、**OpenAI Codex CLI** 和 **OpenAI 兼容 API** 三种引擎，让你无需命令行也能享受 AI 辅助编程的体验。
...
| 特性 | Claude Code | OpenAI Codex | OpenAI Protocol |
|------|-------------|--------------|-----------------|
| 流式响应 | ✅ | ✅ | ✅ |
| 多轮对话 | ✅ | ✅ | ✅ |
| 工具调用 | ✅ MCP Tools | ✅ MCP Tools | ✅ Function Calling |
| 图像生成 | ❌ | ✅ 内置 `image_gen` | ✅ DALL-E API |
| 权限模式 | sandbox/auto/bypass | full-auto/bypass | API 控制 |
| 本地模型 | ❌ | ❌ | ✅ Ollama/vLLM |
